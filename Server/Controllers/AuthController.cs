...
namespace Server.Controllers
{
        ...
        ) : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest registerRequest)
        {
            ...
            return StatusCode(StatusCodes.Status201Created, new AuthResponse() { Token = _jwtTokenGenerator.GenerateToken(user)});
        }
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest loginRequest)
        {
            ...
            return StatusCode(StatusCodes.Status200OK, new AuthResponse() { Token = _jwtTokenGenerator.GenerateToken(user) });
        }
